    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Agency>(entity =>
        {
            ...
            entity.Property(e => e.Address)
                .HasMaxLength(256)
                .IsUnicode(false);
            entity.Property(e => e.IsBroadcastee)
                .HasDefaultValue(true)
                .HasAnnotation("Relational:DefaultConstraintName", "DF_Agency_NotForBroadcast");
        ...
        modelBuilder.Entity<AgencyOrg>(entity =>
        {
            ...
            entity.Property(e => e.AddedAt)
                ...
                .HasAnnotation("Relational:DefaultConstraintName", "DF_Agency_AddedAt")
        ...
        modelBuilder.Entity<CountryOfOrigin>(entity =>
        {
            ...
            entity.Property(e => e.CreatedAt)
                .HasDefaultValueSql("(getdate())")
                .HasAnnotation("Relational:DefaultConstraintName", "DF_Country_Of_Origin_CreatedAt");
        ...
        modelBuilder.Entity<CvwatchLogOld>(entity =>
        {
            ...
            entity.Property(e => e.TimeObserved)
                .HasDefaultValueSql("(getdate())")
                .HasAnnotation("Relational:DefaultConstraintName", "DF_CVWatchLog_TimeObserved")
                .HasColumnType("datetime");
        });
        ...
        modelBuilder.Entity<CvwatchNormal>(entity =>
        {
            ...
            entity.Property(e => e.LastSeenAt)
                .HasDefaultValueSql("(getdate())")
                .HasAnnotation("Relational:DefaultConstraintName", "DF_CVWatchLog_LastSeenAt")
                .HasColumnType("datetime");
            entity.Property(e => e.NewValueAt)
                .HasDefaultValueSql("(getdate())")
                .HasAnnotation("Relational:DefaultConstraintName", "DF_CVWatchLog_NewValueAt")
                .HasColumnType("datetime");
            entity.Property(e => e.Notes)
                .HasMaxLength(4000)
                .IsUnicode(false);
        ...
        modelBuilder.Entity<Ehist>(entity =>
        {
            ...
            entity.Property(e => e.AddedAt)
                .HasDefaultValueSql("(getdate())")
                .HasAnnotation("Relational:DefaultConstraintName", "DF_EHist_AddedAt")
                .HasColumnType("datetime");
            entity.Property(e => e.EmailId)
                .IsRequired()
                .HasMaxLength(256)
        ...
        modelBuilder.Entity<Email>(entity =>
        {
            ...
            entity.Property(e => e.AddedAt)
                .HasDefaultValueSql("(getdate())")
                .HasAnnotation("Relational:DefaultConstraintName", "DF_EMail_AddedAt")
                .HasColumnType("datetime");
            ...
            entity.Property(e => e.LastAction)
                ...
                .HasAnnotation("Relational:DefaultConstraintName", "DF_EMail_ModifiedAt1")
                .HasColumnType("datetime");
            entity.Property(e => e.Lname)
                .HasMaxLength(128)
                .IsUnicode(false)
            ...
            entity.Property(e => e.ModifiedAt)
                .HasDefaultValueSql("(NULL)")
                .HasAnnotation("Relational:DefaultConstraintName", "DF_EMail_AddedAt1_1")
                .HasColumnType("datetime");
            entity.Property(e => e.Notes).IsUnicode(false);
            entity.Property(e => e.NotifyPriority)
                .HasDefaultValue(100)
                .HasAnnotation("Relational:DefaultConstraintName", "DF_EMail_NotifyPriority");
            ...
            entity.Property(e => e.ReSendAfter)
                .HasDefaultValueSql("(NULL)")
                .HasAnnotation("Relational:DefaultConstraintName", "DF_EMail_AddedAt1")
                .HasColumnType("datetime");
        ...
        modelBuilder.Entity<FirstnameRootObject>(entity =>
        {
            ...
            entity.Property(e => e.Name)
                .HasMaxLength(32)
                .HasDefaultValueSql("(getdate())")
                .HasAnnotation("Relational:DefaultConstraintName", "DF_FirstnameRootObject_name")
                .HasColumnName("name");
        ...
        modelBuilder.Entity<Lead>(entity =>
        {
            ...
            entity.Property(e => e.AddedAt)
                .HasDefaultValueSql("(getdate())")
                .HasAnnotation("Relational:DefaultConstraintName", "DF_Lead_AddedAt")
                .HasColumnType("datetime");
            ...
            entity.Property(e => e.CampaignId)
                .HasDefaultValue(3)
                .HasAnnotation("Relational:DefaultConstraintName", "DF_Lead_CampaignId");
            entity.Property(e => e.HourPerDay)
                .HasDefaultValue(8.0)
                .HasAnnotation("Relational:DefaultConstraintName", "DF_Lead_HourPerDay");
            entity.Property(e => e.InterviewedAt).HasColumnType("datetime");
            ...
            entity.Property(e => e.ModifiedAt)
                .HasDefaultValueSql("(NULL)")
                .HasAnnotation("Relational:DefaultConstraintName", "DF_Lead_ModifiedAt")
                .HasColumnType("datetime");
            entity.Property(e => e.Note).IsUnicode(false);
        ...
        modelBuilder.Entity<ObsoleteContactHistoryUseEhist>(entity =>
        {
            ...
            entity.Property(e => e.AddedAt)
                .HasDefaultValueSql("(getdate())")
                .HasAnnotation("Relational:DefaultConstraintName", "DF_ContactHistory_AddedAt")
                .HasColumnType("datetime");
        ...
        modelBuilder.Entity<ObsoleteContactUseEmail>(entity =>
        {
            ...
            entity.Property(e => e.AddedAt)
                .HasDefaultValueSql("(getdate())")
                .HasAnnotation("Relational:DefaultConstraintName", "DF_Contact_AddedAt")
                .HasColumnType("datetime");
            entity.Property(e => e.Company)
                .HasMaxLength(128)
                .IsUnicode(false);
        ...
        modelBuilder.Entity<ObsoleteInterview>(entity =>
        {
            ...
            entity.Property(e => e.HappenedAt)
                .HasDefaultValueSql("(getdate())")
                .HasAnnotation("Relational:DefaultConstraintName", "DF_Interview_HappenedAt")
                .HasColumnType("datetime");
            entity.Property(e => e.Notes)
                .IsRequired()
                .HasMaxLength(5000)
                .IsUnicode(false)
                .HasDefaultValue("")
                .HasAnnotation("Relational:DefaultConstraintName", "DF_Interview_Notes");
        ...
        modelBuilder.Entity<ObsoleteOpportunity>(entity =>
        {
            ...
            entity.Property(e => e.AddedAt)
                .HasDefaultValueSql("(getdate())")
                .HasAnnotation("Relational:DefaultConstraintName", "DF_Opportunity_AddedAt")
                .HasColumnType("datetime");
            entity.Property(e => e.Company)
                .IsRequired()
                .HasMaxLength(150)
            ...
            entity.Property(e => e.Description)
                ...
                .IsUnicode(false)
                .HasDefaultValue("")
                .HasAnnotation("Relational:DefaultConstraintName", "DF_Opportunity_Description");
            entity.Property(e => e.LastActivityAt)
                .HasDefaultValueSql("(getdate())")
                .HasAnnotation("Relational:DefaultConstraintName", "DF_Opportunity_LastActivityAt")
                .HasColumnType("datetime");
            entity.Property(e => e.Location)
                ...
                .IsUnicode(false)
                .HasDefaultValue("")
                .HasAnnotation("Relational:DefaultConstraintName", "DF_Opportunity_Location");
            entity.Property(e => e.RateAsked).HasAnnotation("Relational:DefaultConstraintName", "DF_Opportunity_RateAsked");
            entity.Property(e => e.Start)
                .IsRequired()
                .HasMaxLength(150)
                .IsUnicode(false)
                .HasDefaultValue("")
                .HasAnnotation("Relational:DefaultConstraintName", "DF_Opportunity_Start");
            entity.Property(e => e.Term)
                .IsRequired()
                .HasMaxLength(150)
                .IsUnicode(false)
                .HasDefaultValue("")
                .HasAnnotation("Relational:DefaultConstraintName", "DF_Opportunity_Term");
        ...
        modelBuilder.Entity<Phone>(entity =>
        {
            ...
            entity.Property(e => e.AddedAt)
                .HasDefaultValueSql("(getdate())")
                .HasAnnotation("Relational:DefaultConstraintName", "DF_Phone_AddedAt")
                .HasColumnType("datetime");
            entity.Property(e => e.Notes)
                .HasMaxLength(800)
                .IsUnicode(false);
        ...
        modelBuilder.Entity<PhoneAgencyXref>(entity =>
        {
            ...
            entity.Property(e => e.AddedAt)
                .HasDefaultValueSql("(getdate())")
                .HasAnnotation("Relational:DefaultConstraintName", "DF_PhoneAgencyXRef_AddedAt")
                .HasColumnType("datetime");
        ...
        modelBuilder.Entity<PhoneEmailXref>(entity =>
        {
            ...
            entity.Property(e => e.AddedAt)
                .HasDefaultValueSql("(getdate())")
                .HasAnnotation("Relational:DefaultConstraintName", "DF_PhoneEmailXRef_AddedAt")
                .HasColumnType("datetime");
            entity.Property(e => e.EmailId)
                .IsRequired()
                .HasMaxLength(256)
