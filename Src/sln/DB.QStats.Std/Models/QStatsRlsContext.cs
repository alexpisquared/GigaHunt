...
namespace DB.QStats.Std.Models
{
    public partial class QStatsRlsContext : DbContext
    {
        ...
        public virtual DbSet<FirstnameCountryXref> FirstnameCountryXrefs { get; set; } = null!;
        public virtual DbSet<FirstnameRootObject> FirstnameRootObjects { get; set; } = null!;
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<FirstnameCountryXref>(entity =>
            {
                ...
                entity.HasOne(d => d.CountryNavigation)
                    .WithMany(p => p.FirstnameCountryXrefs)
            ...
            modelBuilder.Entity<FirstnameRootObject>(entity =>
            {
                entity.HasKey(e => e.Name)
                    .HasName("PK_FirstnameRootObjects");
